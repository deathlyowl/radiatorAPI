...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { description: @station.description, genre: @station.genre, name: @station.name, shortcut: @station.shortcut, url: @station.url }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { description: @station.description, genre: @station.genre, name: @station.name, shortcut: @station.shortcut, url: @station.url }
    assert_redirected_to station_path(assigns(:station))
  end
